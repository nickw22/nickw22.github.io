...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 26980, 0, 0).open('GET', '/mainData');
    new DataRequest(26980, 27001, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(27001, 22659557, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(22659557, 24219929, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(24219929, 24734037, 0, 0).open('GET', '/Resources/unity_builtin_extra');
